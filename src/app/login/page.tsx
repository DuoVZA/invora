...
export default function Login() {
    return (
        <div className="w-full bg-zinc-50 box-border p-[74px_12px] flex flex-col items-center">
            ...
            <div className="w-full max-w-[340px] sm:max-w-[380px] bg-[#FFFFFF] rounded-[16px] drop-shadow-[0_4px_4px_rgba(0,0,0,0.25)] p-4 sm:p-5 flex flex-col gap-4 box-border">
                ...
                <div className="w-full flex flex-row justify-between items-baseline border-b border-[#919191] pb-2">
                    <p className="text-sm sm:text-base text-[#000000] font-medium leading-none whitespace-nowrap">
                        З поверненням до <strong className="text-[#4384D0] font-bold">Invora</strong>
                    </p>
                    <Link href="/signup" className="shrink-0 pl-2">
                ...
                <div className="flex flex-col gap-3">
                    ...
                    <button className="w-full border border-zinc-300 text-zinc-700 py-1.5 rounded-full hover:bg-zinc-50 transition-colors font-medium text-xs cursor-pointer whitespace-nowrap">
                        Увійти за допомогою passkey
                    </button>
                </div>

                <div className="flex items-center w-full my-0.5">
                    <div className="flex-1 bg-[#919191] h-[1px]"></div>
                    <p className="px-2 text-[10px] text-[#919191] shrink-0 whitespace-nowrap">або увійти із</p>
                    <div className="flex-1 bg-[#919191] h-[1px]"></div>
                </div>
