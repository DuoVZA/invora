...
export default function GameFilters({ categoryName, options }: GameFiltersProps) {
                        ...
                        {options.map((sub) => {
                            ...
                            return (
                                <button
                                    ...
                                    className={`px-3 py-1.5 text-xs rounded-md font-medium transition-all duration-150 border ${isSelected
